...
data <- read_csv("/Users/jkatz/desktop/Forecasting/CVR/AllTimeIndustryEmploymentRestauranter_202307302232.csv")
...
ggseasonplot(total_aarsvaerk_ts, polar=TRUE) +
  ylab("aarsværk") +
  ggtitle("total_aarsvaerk_ts")

ggseasonplot(total_ansatte_ts, polar=TRUE) +
  ylab("ansatte") +
  ggtitle("total_ansatte_ts")

autoplot(total_aarsvaerk_ts)




########################## Apply time series regression models: https://otexts.com/fpp2/regression-intro.html ############################
